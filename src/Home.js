...
import ViewCoupan from './pages/ViewCoupan';  
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/Label" element={<ProtectedRoute element={<Label />} />} />
        <Route path="/UploadBlogs" element={<ProtectedRoute element={<UploadBlogs />} />} />
        <Route path="/Addblogs" element={<ProtectedRoute element={<Addblogs />} />} />
        <Route path="/BlogList" element={<ProtectedRoute element={<BlogList />} />} />
        <Route path="/ViewCoupan" element={<ProtectedRoute element={<ViewCoupan />} />} />
        ...
        <Route path="/UpdateProducts/:id" element={<ProtectedRoute element={<UpdateProducts />} />} />
