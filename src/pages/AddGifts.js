...
function Admin() {
  ...
  const [wib, setWIB] = useState(''); // For input field
  const [wibs, setWIBS] = useState([]); // For storing points array
  ...
  const handleAddPoint = () => {
    if (wib.trim()) {
      setWIBS([...wibs, wib.trim()]);
      setWIB(''); // Clear the input field
    }
  };
  ...
  const handleSubmit = async (event) => {
    ...
    Object.keys(formData).forEach((key) => {
      if (formData[key]) {
        ...
        data.append('wibs', JSON.stringify(wibs));

    try {
      const response = await axios.post(`${apiUrl}gifts`, data, {
        headers: {
              ...
              <div className="container-fluid">
                <div className="mb-4">
                  <div className='propertys-div'>
                    <h1 className="h3 mb-0 text-white text-center pt-3">Gift Information</h1>

                  </div>
                </div>
                <form onSubmit={handleSubmit}>
                  <div className='row'>
                    <h3 className="pt-3">Gift Basic Information</h3>
        ...
        <option key={categoryObj.id} value={categoryObj.categore}>
          {categoryObj.categore}
                  ...
                  <div className='row mt-4'>
                    <h3 className="pt-3">Gift Details</h3>
                    <div className="form-groups col-md-6">
                  ...
                  <div className='row'>
                    <h3 className="pt-3">Gift SEO Details</h3>
                    <div className="form-groups col-md-6">
...
/>
        ...
        <input
          type="text"
          value={wib}
          onChange={(e) => setWIB(e.target.value)}
          placeholder="Enter what in side the box"
